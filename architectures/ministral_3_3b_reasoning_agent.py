...
Based on mistralai/Ministral-3-3B-Reasoning-2512 architecture
"""
...
# ============================================================================
KV_CACHE_DTYPE = "bf16"  # Default: bf16 for Reasoning model (BF16 weights), options: bf16, fp16, fp8
...
class Ministral3TokenConfig:
    """Agent token configuration (extends reasoning with agent-specific tokens)"""
    
    THINK_START: str = "[THINK]"
    THINK_END: str = "[/THINK]"
    EXECUTE_START: str = "[EXECUTE]"
    EXECUTE_END: str = "[/EXECUTE]"
    OBSERVATION_START: str = "[OBSERVATION]"
    OBSERVATION_END: str = "[/OBSERVATION]"
...
class Ministral3FileConfig:
    ...
    # Base path
    BASE_PATH: str = "model/ministral_3_3b_reasoning_agent"
    
    # For download
    HF_REPO_ID: str = "mistralai/Ministral-3-3B-Reasoning-2512"
    
    # Tokenizer patches: rename special token slots for agent-specific tokens
    TOKENIZER_PATCHES: dict = {
        36: "[EXECUTE]",
        37: "[/EXECUTE]",
        38: "[OBSERVATION]",
        39: "[/OBSERVATION]",
